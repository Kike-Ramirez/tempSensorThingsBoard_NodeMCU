...
tmr.alarm(2, 10000, tmr.ALARM_AUTO, function()
    ...
    if status == dht.OK then
        ...
        print(string.format("DHT Temperature:%d.%03d;Humidity:%d.%03d\r\n",
            ...
            math.floor(humi),
            humi_dec))
        m:publish("v1/devices/me/telemetry", string.format("[{\"temperature\":%d.%03d}, {\"humidity\":%d.%03d}]", math.floor(temp), temp_dec, math.floor(humi), humi_dec), 0, 0, function(client) print("Data sent") end)
